...
import { Bio, CategoryList, CategoryTitle, Divider, Email, GithubLink, Name, ProfileImage, Sidebar, SidebarOverlay } from './ProfileSidebar.styles'
    ...
    <>
      ...
      <div style={{ position: 'relative', width: '100px', height: '100px' }}>
        ...
        >
          ...
          <path d="M 20 70 Q 20 55 50 55 Q 80 55 80 70 L 80 100 Q 80 100 50 100 Q 20 100 20 100 Z" fill="#9ca3af" />
        </svg>
      </div>
      <Name>{name}</Name>
