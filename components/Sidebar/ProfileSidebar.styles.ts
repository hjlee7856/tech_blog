...
export const Sidebar = styled('aside', {
  base: {
    ...
    flexShrink: 0,
    position: { pc: 'sticky', tablet: 'fixed' },
    top: { pc: '0px', tablet: 0 },
    left: { pc: 'auto', tablet: 0 },
    zIndex: { pc: 'auto', tablet: 101 },
    transform: { pc: 'none', tablet: 'translateX(-100%)' },
    transition: { pc: 'none', tablet: 'transform 0.3s ease' },
  },
  variants: {
    isOpen: {
      true: {
